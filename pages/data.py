...
layout = html.Div(
    ...
    children=[
        ...
        html.P("Below you’ll find our processed election data in machine-readable formats:"),
        ...
        html.Ul([
            ...
            html.Li("Prompting parameters: system, temperature, max tokens, model."),
            html.Li("Accuracy checks: Levenshtein for strings, digit-level for numbers."),
            html.Li("Final accuracy: 100% (most fields), 94% (candidate), 98% (votes)."),
        ]),
        html.P(
