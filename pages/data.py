...
layout = html.Div(
    ...
    children=[
        ...
        html.Ol(
            [
                html.Li(
                    "Over 3,000 pages of PDFs were retrieved through a web scraper built using Selenium"
                ),
                html.Li("PDFs were converted to PNG format for optimal LLM processing"),
                html.Li(
                    "Images were processed through Claude API to create raw CSV files"
                ),
                html.Li(
                    "Data was cleaned through multiple iterations of revised prompting"
                ),
                html.Li(
                    "Accuracy was evaluated using training and testing datasets (10% sample)"
                ),
        ...
        html.Ul(
            [
                html.Li(
                    [
                        html.Strong("System: "),
                        "Provides context and instructions to Claude",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Temperature: "),
                        "Set to 0 for consistent, deterministic output",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Max tokens: "),
                        "Controls the length of Claude's output",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Model: "),
                        "Claude was selected after comparative testing",
                    ]
                ),
            ]
        ),
        ...
        html.Ul(
            [
                html.Li(
                    "Addressed formatting challenges in 1920-1924 data (two-column format)"
                ),
                html.Li("Set temperature to 0 for consistency and faster processing"),
                html.Li(
                    "Used system parameters to handle errors and ensure CSV-only output"
                ),
                html.Li(
                    "Added specific instructions: 'Write names exactly as they appear, do not try to predict correct spellings'"
                ),
            ]
        ),
        ...
        html.H4(
            "Performance Results", style={"marginTop": "20px", "marginBottom": "15px"}
        ),
        html.Div(
            style={
                "display": "flex",
        ...
        html.Ul(
            [
                html.Li(
                    [
                        html.Strong("Claude demonstrated superior performance: "),
                        "Significantly outperformed ChatGPT in data collection and OCR tasks",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Candidate name accuracy challenges: "),
                        "Achieved 94% accuracy through extensive prompt engineering",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("ChatGPT limitations: "),
                        "Poor performance on candidate names (70%) and vote counts (80%)",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Consistent structured data: "),
                        "Both models performed perfectly on standardized fields",
                    ]
                ),
            ]
        ),
        ...
        html.Ul(
            [
                html.Li(
                    [
                        html.Strong("Training/Testing Split: "),
                        "10% of data used for accuracy evaluation",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Levenshtein Distance Testing: "),
                        "String-based accuracy measurement for text fields",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Numerical Accuracy Validation: "),
                        "Custom digit-level accuracy for vote counts",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Cross-Model Validation: "),
                        "Comparative testing between Claude and ChatGPT",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Final Accuracy: "),
                        "100% accuracy for most variables, 94% for candidate names, 98% for vote counts",
                    ]
                ),
            ]
        ),
        ...
        html.P(
            "All original election results are from the official US House of Representatives archive:"
        ),
        html.A(
