...
layout = html.Div(
    ...
    children=[
        ...
        html.Ul(
            [
                html.Li(
                    "3,000+ PDF pages scraped from the US House Election Statistics archive"
                ),
                html.Li("PDFs converted to PNG images for optimal LLM processing"),
                html.Li(
                    "Advanced prompt engineering to ensure complete variable extraction"
                ),
                html.Li(
                    "Systematic testing of prompting parameters: system prompts, temperature, max tokens, and model selection"
                ),
                html.Li(
                    "Regular expression preprocessing for data noise reduction and post-processing for corrections"
                ),
                html.Li(
                    "Rigorous accuracy validation using Levenshtein distance for text and digit-level comparison for numbers"
                ),
            ]
        ),
            ...
            [
                html.Li(
                    [
                        ...
                        "Significantly outperformed ChatGPT in data collection and OCR tasks, particularly for complex fields like candidate names and vote counts",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Candidate name accuracy challenges: "),
                        "Initially faced difficulties with candidate name recognition due to variability and length, but achieved 94% accuracy through extensive prompt engineering",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("ChatGPT limitations: "),
                        "Provided unsatisfactory results for diverse entries, with particularly poor performance on candidate names (70%) and vote counts (80%)",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Consistent structured data: "),
                        "Both models performed perfectly on standardized fields (State, Race Type, District), but Claude excelled in variable content extraction",
                    ]
                ),
            ]
        ),
            ...
            [
                ...
                html.Li(
                    [
                        ...
                        "Digit-level comparison for vote count precision",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Cross-Model Validation: "),
                        "Comparative testing between multiple LLM models",
                    ]
                ),
                html.Li(
                    [
                        html.Strong("Manual Quality Checks: "),
                        "Human verification of complex cases and edge scenarios",
                    ]
                ),
            ]
        ),
