...
def load_election_data():
    ...
    election_data = election_data[
        election_data["office"].isin(["Presidential", "House"])
    ]
...
def create_bar_chart():
    ...
    try:
        ...
        grouped = election_data.groupby(["state", "party"], as_index=False)[
            "votes"
        ].sum()
        ...
        fig.update_layout(
            barmode="stack", xaxis_title="State", yaxis_title="Total Votes"
        )
        fig.show()
    ...
    try:
        ...
        return html.Div(
            [
                ...
                dcc.Graph(
                    id="election-bar-chart", figure=fig, style={"height": "600px"}
                ),
                html.P(
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.P(
                            "Please ensure the 1932.csv file is in the correct location.",
