"""Image transformation utilities for PDF processing.

This module provides functions to convert PDF files to images,
supporting batch processing of multiple PDFs. It handles various
error conditions and provides configurable output options.
"""
...
def pdf_to_images(
    ...
    if image_format.upper() not in ["PNG", "JPEG", "TIFF"]:
    ...
    for i, image in enumerate(images, start=1):
        ...
        try:
            ...
            raise OSError(f"Failed to save image {image_path}: {str(e)}") from e
